...
public class LongestSubString {
	...
	public static void main(String[] args) {
		// Find out longest substring of a String
		String str = new String("abcabcbb");
		System.out.println("Longest Substring: " + lengthOfLongestSubstring(str));
		
		System.out.println("Unique Substring: " + longestUniqueSubsttr(str));
